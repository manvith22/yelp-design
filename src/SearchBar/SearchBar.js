    ...
    return(
        <div>
            <div className="field has-addons">
               ...
               <p className="control">
                  <input className={`input ${sizeClass} ${styles['input-control']}`} type="text" placeholder="burgers,spas,barber,bars"/>
               </p>
               <p className="control">
               ...
               <button className={`button ${sizeClass} ${styles['search-bar']}`}>
